...
"
" PACKAGE MANAGEMENT
" IF SOMETHING DO NOT WORK WITH VIM plugin use  :PlugClean
""""""""""""""""""""""""""""""""
" start vim-plug
...
"  Plug 'nvim-tree/nvim-web-devicons' "new
Plug 'nvim-tree/nvim-tree.lua'     "new
"  Plug 'nvim-treesitter/nvim-treesitter', {'do': ':TSUpdate'} " new
...
Plug 'lewis6991/gitsigns.nvim' "new

" typing automations
Plug 'jiangmiao/auto-pairs'
Plug 'windwp/nvim-autopairs' "new
...
" snippets                                                          new                              new
Plug 'SirVer/ultisnips' | Plug 'honza/vim-snippets' | Plug 'rafamadriz/friendly-snippets' | Plug 'L3MON4D3/LuaSnip', {'tag': 'v<CurrentMajor>.*', 'do': 'make install_jsregexp'}
